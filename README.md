...
During the preparation phase, missing review ratings were imputed using the median rating per category, column names were standardized, categorical purchase frequencies were converted into numeric values (days), and redundant promotional variables were removed to avoid 
...
![Data_Analysis_Costumer_Behavior](Sales_by_Age_Group.png)


[Visualization: Revenue and Sales by Age Group]
...
[Visualization: Average Purchase Amount & Revenue Distribution]
