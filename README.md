...
The Python code used to inspect and clean the data for this analysis can be found here: [[Costumer_Data_Cleaning.py](https://github.com/DaviGusstschenko/Data_Analysis_Costumer_Behavior/blob/main/Costumer_Data_Cleaning.py)].
...
An interactive Power BI dashboard used to explore customer behavior and sales trends can be found here: [[Customer_Behavior_DashBoard.pbix](Costumer_Behavior_DashBoard.pbix)]. (You'll have to download it)
